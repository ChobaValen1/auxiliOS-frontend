-- AuxiliOS · resumen de excedentes a cargo del socio en la cola del Chofer.
...
comment on function public.get_driver_operator_queue_v2() is
  'Cola privada del Chofer con resumen operativo y excedentes a cargo del socio sin exponer tablas.';
