...
function render(){
  ...
  const tiles=`<div class="rqc-tiles">
    ...
    <div class="rqc-tile"><span>Respuesta a la encuesta</span><b>${pct(t.respondidas||0,t.enviados||0)}</b><em>${t.respondidas||0} de ${t.enviados||0} enviadas · ${t.enviados||0} de ${t.remitos||0} remitos con link</em></div>
