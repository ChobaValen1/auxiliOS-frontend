...
(() => {
  ...
  function ensureModal() {
    ...
    document.body.insertAdjacentHTML('beforeend', `<div class="modal-backdrop" id="modal-service-type-crud-v2"><div class="modal-box st2-modal">
      ...
      </div><div style="display:flex;gap:20px;flex-wrap:wrap;margin-top:14px"><label class="st2-check"><input type="checkbox" id="st2-adds-km"><span>Suma kilómetros</span></label><label class="st2-check" title="El servicio se resuelve en el origen: no pide destino y el recorrido es Base → Origen → Base."><input type="checkbox" id="st2-single-address"><span>Una sola dirección (se resuelve en el origen)</span></label><label class="st2-check"><input type="checkbox" id="st2-active" checked><span>Servicio activo</span></label></div>
