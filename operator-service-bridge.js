...
async function restoreServiceDraft(s){
  if(!s?.remito_id||s.remito_status!=='pendiente')return false;
...
Object.assign(window,{actualizarServiciosAsignados:()=>loadQueue(),abrirPreviewServicio:openPreview,cerrarPreviewServicio:closePreview,confirmarServicioActivado:confirmActivated,marcarServicioActivado:markActivated,abrirRemitoServicio:openRemito,abrirRemitoSinAsignacion:openAdHocRemito,cambiarVistaServiciosChofer:setView,obtenerServicioAsignadoRemito:()=>findService(sessionStorage.getItem('auxilios_phase3_service_id'))});
